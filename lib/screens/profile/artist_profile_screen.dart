              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    // 🔥 ÖNE ÇIKAR BUTONU (GÜNCELLENDİ)
                    if (isOwnProfile)
                      Positioned(
                        top: 40,
                        right: 60, // Ayarlar butonunun solunda durması için mesafeyi ayarladık
                                                    ...
                                                    children: [
                                                      ...
                                                      if (_user!.locationString.isNotEmpty)
                                                        Text(
                                                          ...
                                                          style: TextStyle(fontSize: 11, fontStyle: FontStyle.italic, color: AppTheme.primaryLightColor.withOpacity(0.5)),
                                                        ),
                                                    ],
                                                  ),
                                                ),
                                ...
                                Expanded(
                                  child: _isFollowing 
                                    ? ElevatedButton(
                                        ...
                                        child: Text('Takibi Bırak', style: TextStyle(color: AppTheme.backgroundColor,)),
                                      )
                                    : OutlinedButton(
                                        onPressed: _toggleFollow,
                    ...
                    // --- ÖNE ÇIKAR SATIŞ SAYFASI (GÜNCEL) ---
                      ...
                      // 🔥 BURASI DOSYANIN EN DIŞI OLMALI//
